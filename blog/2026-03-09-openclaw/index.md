...
![nvm安装界面](./nvm-install.png)

安装成功后，请使用**管理员身份**打开 PowerShell，执行 `nvm version` 验证安装。

![nvm version验证](./nvm-version.png)
...
![安装飞书插件](./install-feishu-plugin.png)
...
![创建应用凭证](./create-app-credentials.png)
...
![事件订阅与长连接](./event-subscription.png)
